...
class _$_BadResponse implements _BadResponse {
  ...
  @override
  String toString() {
    return 'FailureDetails.badResponse(details: $details)';
  }
...
abstract class _BadResponse implements FailureDetails {
...
class _$_TimeoutError implements _TimeoutError {
  ...
  @override
  String toString() {
    return 'FailureDetails.timeoutError(error: $error, stackTrace: $stackTrace)';
  }
...
abstract class _TimeoutError implements FailureDetails {
...
class _$_NetworkProblem implements _NetworkProblem {
  ...
  @override
  String toString() {
    return 'FailureDetails.networkProblem(error: $error, stackTrace: $stackTrace)';
  }
...
abstract class _NetworkProblem implements FailureDetails {
