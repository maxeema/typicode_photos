...
class _$FailureTearOff {
  ...
  _DetailedReason<R> detailed<R>(R reason) {
    return _DetailedReason<R>(
      reason,
    );
  }

  _EmptyData<R> emptyData<R>() {
    return _EmptyData<R>();
  }

  _DataIntegrityError<R> dataIntegrity<R>(Object error, StackTrace stackTrace) {
  ...
  _UnknownError<R> unknown<R>(Object error, StackTrace stackTrace) {
...
/// @nodoc
abstract class $FailureCopyWith<R, $Res> {
  factory $FailureCopyWith(Failure<R> value, $Res Function(Failure<R>) then) =
      _$FailureCopyWithImpl<R, $Res>;
}

/// @nodoc
class _$FailureCopyWithImpl<R, $Res> implements $FailureCopyWith<R, $Res> {
...
/// @nodoc
abstract class _$DetailedReasonCopyWith<R, $Res> {
...
/// @nodoc
class __$DetailedReasonCopyWithImpl<R, $Res>
...
class _$_DetailedReason<R> implements _DetailedReason<R> {
...
abstract class _DetailedReason<R> implements Failure<R> {
...
/// @nodoc
abstract class _$EmptyDataCopyWith<R, $Res> {
...
/// @nodoc
class __$EmptyDataCopyWithImpl<R, $Res> extends _$FailureCopyWithImpl<R, $Res>
...
class _$_EmptyData<R> implements _EmptyData<R> {
  const _$_EmptyData();
...
abstract class _EmptyData<R> implements Failure<R> {
  const factory _EmptyData() = _$_EmptyData<R>;
}

/// @nodoc
abstract class _$DataIntegrityErrorCopyWith<R, $Res> {
...
/// @nodoc
class __$DataIntegrityErrorCopyWithImpl<R, $Res>
    extends _$FailureCopyWithImpl<R, $Res>
...
class _$_DataIntegrityError<R> implements _DataIntegrityError<R> {
...
abstract class _DataIntegrityError<R> implements Failure<R> {
...
/// @nodoc
abstract class _$UnknownErrorCopyWith<R, $Res> {
...
/// @nodoc
class __$UnknownErrorCopyWithImpl<R, $Res>
    extends _$FailureCopyWithImpl<R, $Res>
...
class _$_UnknownError<R> implements _UnknownError<R> {
...
abstract class _UnknownError<R> implements Failure<R> {
